/* =========================================================
   ...
   Menu mobile (Bootstrap Collapse) + busca + envio de formulários
   (Supabase) com honeypot
   ========================================================= */
...
/* ---- Fecha o menu mobile (Bootstrap Collapse) ao clicar em um link ---- */
(function () {
...
(function () {
  ...
  // Indice das secoes e paginas. Links relativos a raiz, funcionam de qualquer pagina.
  const INDEX = [
    ...
    { t: 'Perguntas frequentes de BI', k: 'faq duvida perguntas frequentes prazo ajuste licenca', u: 'bi.html#faq' },
    { t: 'Solicitar proposta de BI', k: 'solicitar proposta contato bi formulario projeto', u: 'bi.html#contato' },
    { t: 'Estudo de caso (agro)', k: 'estudo de caso agro rls projeto exemplo prova nota fiscal transporte regional', u: 'caso-agro.html' },
